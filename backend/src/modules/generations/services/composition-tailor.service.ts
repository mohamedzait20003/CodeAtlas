...
import type { TailorView } from '@/modules/generations/dto/composition.dto';

/** Turns a rough note into a sharp instruction for the composition agent. */
...
@Injectable()
export class CompositionTailorService {
  constructor(
